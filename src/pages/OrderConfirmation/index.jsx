        ...
        <section className="flex lg:flex-row flex-col ">
          <article className="lg:flex-1 w-full">
            <div className="lg:pr-12 2xl:pr-28 px-4 sm:px-10 md:px-28 lg:px-0 mb-12 lg:mb-0">
              <p className="font-HelveticaBold normal-case text-[30px] lg:text-[45px] tracking-[0.125em] leading-[1.2];">
                Thank you for your purchase!
              </p>
              <p className="leading-[1.4] tracking-[0.04em] mt-5">
                Your order will be processed within 24hours during working days.
              ...
              <section className="pt-16">
                <div className="relative top-1/2 left-1/2 -translate-x-1/2 w-[300px] sm:w-[450px] md:w-[500px] lg:w-[400px] xl:w-[400px] 2xl:w-[500px] h-[2px] bg-blackPrimary ">
                  <div className="bg-blackPrimary top-[-15px] left-0 rounded-[50%] w-8 h-8 relative  after:absolute after:top-[6px] after:left-[12px] after:w-[7px] after:h-[14px] after:rotate-45 after:border-r-[2px] after:border-b-[2px]"></div>
                  ...
                  <article className="absolute top-6 left-[-20px] flex flex-col items-center">
                    ...
                    <p className="text-[14px]  text-grey1 leading-[1.4] tracking-[0.04em]">
                      {formattedDate(orderConfirmation.createdAt)}
                    </p>
                  </article>
                  <article className="absolute top-6 left-1/2 -translate-x-1/2 text-[14px] font-medium leading-[1.4] tracking-[0.04em]">
                    Ready to ship
                  </article>
                ...
                <div className="mt-28">
                  ...
                  <table className="mt-6 w-[70%]">
                    <tbody>
                      <tr>
                        <td className="font-HelveticaBold text-[16px] leading-[1.20833] tracking-[0.08em]">
                          Name
                        </td>
                        <td className="pt-2 leading-[1.4] tracking-[0.04em]">
                      ...
                      <tr className="mt-2">
                        ...
                        <td className="pt-2 max-w-[150px] leading-[1.4] tracking-[0.04em]">
          ...
          <section className="flex-1 lg:px-0 px-4 sm:px-10 md:px-28">
            <div className="w-full h-8 bg-[#E9DED6] rounded-2xl"></div>
            <div className="w-full flex flex-col items-center px-3 relative">
              <div className="w-full mt-[-15px] bg-[#F2F2F4] px-3 sm:px-12">
                <div className="w-full pt-10">
                  <p className="furniture-divided-bottom pb-8 font-HelveticaBold text-[32px] leading-[1.20833] tracking-[0.08em]">
                    Order summary
                  </p>
                  <div className="grid grid-cols-3 divide-x-[2px] divide-grey4 mt-4 w-full pb-14">
                    <article className="flex flex-col items-center justify-center">
                      <p className="">Date</p>
                      <p className="font-HelveticaBold text-[12px] sm:text-[14px]">
                        {formattedDate(orderConfirmation.createdAt)}
                      </p>
                    </article>
                ...
                <div
                  className={`furniture-divided-bottom pb-8 ${
                    orderProduct.length > 2
                      ? "overflow-y-auto h-[320px]"
                      : "overflow-y-hidden"
                  }`}
                >
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-row gap-5">
                          ...
                          <div className="flex flex-col justify-between">
                            <div>
                              ...
                              <p className="text-[11px] sm:text-[13px] leading-[1.4] tracking-[0.04em]">
                        ...
                        <div className="flex flex-col">
                          ...
                          <p
                            className={`font-HelveticaBold text-[13px] sm:text-[16px] leading-[1.20833] tracking-[0.08em] ${
                              !onSale && "pt-2"
                            }`}
                          >
              ...
              <img
                className="absolute w-6 top-48 left-2"
                src="https://res.cloudinary.com/dc4hafqoa/image/upload/v1709827911/eFurniture/half-circle_txlc64.png"
              ></img>
              <img
                className="absolute w-6 top-48 right-2 rotate-180"
                src="https://res.cloudinary.com/dc4hafqoa/image/upload/v1709827911/eFurniture/half-circle_txlc64.png"
              ></img>
              <img
                className="absolute w-full px-10 top-48 left-0"
                src="https://res.cloudinary.com/dc4hafqoa/image/upload/v1709828591/eFurniture/d_beitnd.png"
              ></img>
            </div>
          </section>
        </section>
