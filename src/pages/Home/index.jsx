    ...
    <section className="min-h-screen">
      <header className="grid grid-cols-[62.5%_37.5%] pr-[85px]">
        ...
        <div className="ml-[3.5rem] flex flex-col items-start justify-end">
          <p className="font-HelveticaBold text-[40px] leading-[56px] tracking-[0.08em] pb-6">
            LIVE STYLE FOR LESS
          </p>
      ...
      <section className="grid grid-cols-[1fr_1fr] mb-[4.5rem]">
        <div className="flex flex-col items-start justify-end px-[68px]">
          <p className="font-HelveticaBold text-[40px] leading-[1.23] tracking-[0.15em] pb-6 line-clamp-3">
            GIFT IDEAS FOR <br /> EVERYONE ON YOUR <br /> LIST
          </p>
          <p className="font-Baskerville text-[1.25rem] pb-6">
            Take the guesswork out of gift giving and discover our collection of
            foolproof gift ideas for every and any occasion.
          </p>
