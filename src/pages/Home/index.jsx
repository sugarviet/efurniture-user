...
const Home = () => {
  return (
    <div className="min-h-screen">
      <div className="grid grid-cols-[62.5%_37.5%] pr-[85px]">
      ...
      <div className="pl-[68px] mb-[5.5rem]">
      ...
      <div className="grid grid-cols-[1fr_1fr] mb-[4.5rem]">
      ...
      <div className="grid grid-cols-[1fr_1fr] mb-[4.5rem] px-[68px]">
        <div className="flex flex-col items-start justify-end pr-[120px]">
          <p className="font-HelveticaBold text-[40px] leading-[1.2] tracking-[0.15em] pb-10 line-clamp-3">DANISH DESIGN FURNITURE BY BOCONCEPT</p>
